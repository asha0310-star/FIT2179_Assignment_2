...
| Malaysian Palm Oil Board overview reports (`raw/Annual Overview Reports Overview 2024.pdf` and public 2025 overview figures typed into `wrangle.py`) | `data/malaysia_yearly.csv`, `data/malaysia_palmoil_kpi.csv`, `data/state_cpo_2025.csv`, `data/top_importers_2025.csv`, `data/imports_flows.csv`, `data/malaysia_economy_yearly.csv` | Malaysia production, planted area, regional 2025 production, export values, and top export destinations. |
| Global Forest Watch (`raw/Global Forest Watch Data.xlsx`)                                                                                            | `data/forest_loss_by_state_long.csv`, `data/forest_loss_state_totals.csv`, `data/area_vs_loss_yearly.csv`                                                                           | State and national tree-cover loss, 2001–2024.                                                           |
